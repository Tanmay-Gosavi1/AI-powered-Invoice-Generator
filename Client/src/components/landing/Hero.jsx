        ...
        <div className='min-h-screen pt-18 sm:pt-25'>
            ...
            <div className='px-6 sm:px-10 max-w-6xl mx-auto'>
                <div className='text-center py-5'>
                    <h1 className='capitalize font-extrabold text-4xl sm:text-5xl lg:text-7xl tracking-tight text-blue-950'>AI-powered invoicing , made effortless</h1>
                </div>
                <div className='pb-10 pt-5 text-center '>
                    <h1 className='text-base sm:text-lg font-medium text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor pariatur libero et mollitia animi quos, quod consectetur quibusdam esse, ratione amet, veniam deleniti eaque quas? Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, similique.</h1>
                </div>
            ...
            <div className='max-w-7xl mt-12  mx-auto overflow-hidden bg-cover px-6 pb-10'>
                ...
                <img className='w-full shadow-lg rounded-xl' src="/Hero.png" alt="Hero" />
            </div>
        </div>
    </section>
  )
