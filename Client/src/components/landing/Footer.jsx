        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                ...
                <div className='space-y-4 md:col-span-2 lg:col-span-1'>
                    <Link to='/' className='flex items-center space-x-4 mb-6'>
                        ...
                        <p className='text-xl font-bold'>InvoicelyAI</p>
                    </Link>
                    <p className='text-gray-400 leading-relaxed max-w-sm text-base'>The simplest way to create and manage invoices.</p>
                </div>
            ...
            <div className='border-t border-gray-800 py-8 mt-16'>
                <div className='flex flex-col md:flex-row justify-between items-center'>
                    <p className='text-gray-400 text-sm'>&copy; 2024 InvoicelyAI. All rights reserved.</p>
